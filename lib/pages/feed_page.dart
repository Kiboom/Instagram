  ...
  Widget _buildActiveUsers() {
    return Container(
      ...
      child: ListView(
        ...
        children: [for (final userName in _loggedInUsers) _buildActiveUserCircle(userName)],
      ),
    );
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Colors.yellow, Colors.orangeAccent, Colors.redAccent, Colors.purpleAccent],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFFF1F2F3)),
        child: Container(
